...
SliderDisplay.BASE_Y = 407;

// not sure if SliderDisplay is the best place to put this but OK
SliderDisplay.timeAtEpoch = function (epoch) {
    var seconds = Math.floor(SliderDisplay.SECONDS_PER_EPOCH * epoch); // 50 blocks * 14 seconds/block
...
SliderDisplay.SECONDS_PER_EPOCH = 700;